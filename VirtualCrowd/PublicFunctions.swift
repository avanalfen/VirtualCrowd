...
public func date(date: Date?) -> (time: String, shortStyle: String, mediumStyle: String, longStyle: String, relativeStyle:String) {
    ...
    return (time, shortStyleDate, mediumStyleDate, longStyleDate,relativeDate)
}
